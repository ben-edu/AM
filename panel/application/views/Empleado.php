                        ...
                        <form class="cmxform" id="signupForm" method="get" action="">
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="usser" name="usser" required>
                              <span class="bar"></span>
                              <label>Usuario</label>
                            </div>
                          </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="contrasena" name="contrasena" required>
                                <span class="bar"></span>
                          ...
                          <div class="col-md-12"><br><br><br><br><br><br>
                              <input type="submit" class="btn  btn-3d btn-success" value="Guardar Empleado"/>
                          </div>
                        </form>
                ...
                <ul class="nav nav-list">
                    <li class="active ripple">
                      ...
                      <ul class="nav nav-list tree">
                          <li><a href="dashboard-v1.html">Agregar </a></li>
