                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="get" action="">
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="appaterno" name="appaterno" required>
                              <span class="bar"></span>
                            ...
                            <div class="col-md-6">
                              <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="apmaterno" name="apmaterno" required>
                                <span class="bar"></span>
                            ...
                            <div class="col-md-6">
                              <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="edad" name="edad" required>
                                <span class="bar"></span>
                                <label>Edad</label>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="afiliacion" name="afiliacion" required>
                                <span class="bar"></span>
                          ...
                          <div class="col-md-12">
                              <input type="submit" class="btn  btn-3d btn-success" value="Guardar Paciente"/>
                          </div>
                        </form>
