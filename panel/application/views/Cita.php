...
<head>
    ...
    <!-- start: Css -->
    <link rel="stylesheet" type="text/css" href="../../assetp/css/bootstrap.min.css">

      <!-- plugins -->
      <link rel="stylesheet" type="text/css" href="../../assetp/css/plugins/font-awesome.min.css"/>
      <link rel="stylesheet" type="text/css" href="../../assetp/css/plugins/simple-line-icons.css"/>
      <link rel="stylesheet" type="text/css" href="../../assetp/css/plugins/animate.min.css"/>
      <link rel="stylesheet" type="text/css" href="../../assetp/css/plugins/fullcalendar.min.css"/>
	<link href="../../assetp/css/style.css" rel="stylesheet">
	<!-- end: Css -->

	<link rel="shortcut icon" href="../../assetp/img/logomi.png">
                        ...
                        <form class="cmxform" id="signupForm" method="get" action="">
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombre_doctor" name="nombre_doctor" required>
                              <span class="bar"></span>
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombre_paciente" name="nombre_paciente" required>
                              <span class="bar"></span>
                            ...
                            <div class="col-md-6">
                              <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="no_consultorio" name="no_consultorio" required>
                                <span class="bar"></span>
                            ...
                            <div class="col-md-6">
                              <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="date" class="form-text" id="fecha" name="fecha" required>
                                <span class="bar"></span>
                                <label>Fecha</label>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" id="estatus" name="estatus" required>
                                <span class="bar"></span>
                                <label>Estatus</label>
                              </div>
                            </div>
                          ...
                          <div class="col-md-12">
                              <input type="submit" class="btn  btn-3d btn-success" value="Guardar Cita"/>
                          </div>
                        </form>
                ...
                <div id="right-menu-user" class="tab-pane fade in active">
                  ...
                  <div class="user col-md-12">
                   <ul class="nav nav-list">
                    <li class="online">
                      <img src="../../assetp/img/avatar.jpg" alt="user name">
                      <div class="name">
                        ...
                        <div class="row msg_container send">
                          <div class="col-md-9 col-xs-9 bubble">
                            ...
                            <div class="col-md-3 col-xs-3 avatar">
                              <img src="../../assetp/img/avatar.jpg" class=" img-responsive " alt="user name">
                            </div>
                          </div>
                                ...
                                <ul>
                                  <li class="online">
                                    <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                                      <div class="user-avatar"><img src="../../assetp/img/avatar.jpg" alt="user name"></div>
                                      <div class="dot"></div>
                                    </a>
                                  </li>
                                  <li class="offline">
