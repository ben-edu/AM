                        ...
                        <form class="cmxform" id="signupForm" method="get" action="">
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombre_consultorio" name="nombre_consultorio" required>
                              <span class="bar"></span>
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="especialidad" name="especialidad" required>
                              <span class="bar"></span>
                          ...
                          <div class="col-md-12">
                              <input type="submit" class="btn  btn-3d btn-success" value="Guardar Doctor"/>
                          </div>
                        </form>
